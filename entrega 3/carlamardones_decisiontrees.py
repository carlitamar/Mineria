#*******************************************************************************************
# Autor: Carla Mardones
# Fecha: 3/12/2019
# Contenidos:  Programa y funciones para realizar Clasificación y medición 
#              de valores de evaluación para arboles de decision
#*******************************************************************************************
# Con referencias de codigo "decisiontrees.py" de
# Autor: John Atkinson
# Fecha: 24/07/2019
...
def CargarDatos(FileName):   
    ...
    df = pd.DataFrame(datatable,columns=['age','education.num','relationship','sex','hours.per.week','income'])
...
#% de datos para entrenamiento (lo restante para probar)
Train,Test = SepararDatos(0.1,Datos)  
...
#imprimir valor de accuracy
print("Accuracy:",metrics.accuracy_score(Ytest, Ypred))

#*****************************************************************   
# Imprimir arbol de decisión de acuerdo a variables seleccionadas
#***************************************************************** 
...
#*****************************************************************   
# Imprimir matriz con valores de precision, recall, f1-score
#*****************************************************************     
print(metrics.classification_report(Ytest, Ypred))

#*****************************************************************   
# Imprimir matriz con valores de true positives, false positives, 
#                               y true negative y false negatives
#*****************************************************************   
